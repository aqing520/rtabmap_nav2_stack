#!/usr/bin/env python3
"""
Mapping bringup with FAST-LIO + optional RTK GPS.

Based on fastlio_mapping.launch.py with added GPS support via
navsat_transform_node and RTAB-Map GPS constraints.
...
Usage:
  ros2 launch robot_bringup fastlio_mapping_rtk.launch.py
  ros2 launch robot_bringup fastlio_mapping_rtk.launch.py enable_gps:=false
  ros2 launch robot_bringup fastlio_mapping_rtk.launch.py start_livox:=false rviz:=true
"""
...
def generate_launch_description() -> LaunchDescription:
    ...
    # ── 6. RTAB-Map SLAM ──
    # Build RTAB-Map args string: always include ICP tuning,
    # conditionally add --delete_db_on_start.
    ...
    # Core RTAB-Map launch arguments (always applied)
    rtabmap_la = {
        'use_sim_time': use_sim_time,
        'localization': 'false',
